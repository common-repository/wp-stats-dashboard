...
class WPSDStatsFactory {
	...
	function create($type) {
		...
		switch($type) {
			...
			break;
			case 5: 
				//include_once('metrics/WPSDCompeteRank.php');
				//return new WPSDCompeteRank(get_bloginfo('url'), true);
			break;
			case 6: 
				include_once('metrics/WPSDYahooRank.php');
				return  new WPSDYahooRank(get_bloginfo('url'), true);
			break;
			case 7: 
				include_once('metrics/WPSDMozRank.php');
				return new WPSDMozRank();
			break; 
			case 8: 
				//include_once('metrics/WPSDPostRank.php');
			...
			case 10: 
				include_once('metrics/WPSDEngagement.php');
				return new WPSDEngagement();
			break;
			case 11: 
				include_once('metrics/WPSDLinkedIn.php');
				return new WPSDLinkedIn(true);
			break;
			case 12: 
				include_once('metrics/WPSDGoogleBackLinks.php');
			...
			break;
			case 16: 
				include_once('metrics/WPSDKlout.php');
				return new WPSDKlout();
			break;
			case 17: 
				include_once('metrics/WPSDFeedBurner.php');
				return new WPSDFeedBurner();
			break;
			case 18: 
				include_once('metrics/WPSDLastFm.php');
				return new WPSDLastFm();
			break;
			case 19: 
				include_once('metrics/WPSDFaceBook.php');
			...
			//break;	
			case 21: 
				include_once('metrics/WPSDStumbleUpon.php');
			...
			break;*/
			case 23: 
				include_once('metrics/WPSDYoutube.php');
				return new WPSDYoutube();
			break;
			case 24: 
				include_once('metrics/WPSDMyspace.php');
			...
			break;*/
			case 26:
				include_once('metrics/WPSDRunkeeper.php');
				return new WPSDRunkeeper();
			break;
			case 27: 
				include_once('metrics/WPSDGooglePlus.php');
				return new WPSDGooglePlus();
			break;
			case 28: 
				//include_once('metrics/WPSDPeerIndex.php');
				//return new WPSDPeerIndex();
			break;
			// 29.
			case 30: include_once('metrics/WPSDPinterest.php');
				return new WPSDPinterest();
			break;
		}
