...
<div class="wrap">
  ...
  <div class="error fade">
    <p> <strong>
      ...
      <a href="http://wordpress.org/extend/plugins/jetpack/" target="_blank" title="<?php _e('Please install the Jetpack plugin first', 'wpsd'); ?>">http://wordpress.org/extend/plugins/jetpack/</a> </p>
  </div>
  <?php } ?>
          ...
          <div class="inside">
            ...
            <table class="form-table" cellspacing="2" cellpadding="5" width="100%">
              ...
              <tr>
                ...
                <?php /*  <input type="checkbox" name="wpsd_widget_compete"<?php echo $form->getWpsdWidgetCompete() ? $checked : ''; ?> />
          ...
          <table class="form-table" cellspacing="2" cellpadding="5" width="100%" background="">
			...
			<tr>
              ...
              <tr class="highlight">
               ...
               <tr>
                <th scope="row"><img src="<?php echo $img_path; ?><?php echo $types['pinterest'][1]; ?>.png" alt="Pinterest logo" /> 
                <label for="wpsd_pinterest_un">
                    <?php _e('Pinterest username','wpsd'); ?>
                    :</label>
                </th>
                <td><?php
												echo "<input type='text' size='60' ";
												echo "name='wpsd_pinterest_un' ";
												echo "id='wpsd_pinterest_un' ";
												echo "value='".$form->getWpsdPinterestUn()."'" .
														"/>\n";
												?>
                  <?php 
                  	wpsd_jtip(
                  		__('Pinterest', 'wpsd'), 
                  		__('Pinterest username. http://pinterest.com/<strong>daveligthart</strong>. Registration required.','wpsd')); 
                  	
                  	wpsd_go('http://pinterest.com', __('Hunch', 'wpsd')); 
